...
const AdminLayout = () => {
  return (
    <div className="flex max-w-screen-2xl min-h-screen mx-auto bg-gradient-to-br from-black via-slate-900 to-black">
      <aside className="hidden md:block w-50 fixed h-full backdrop-blur-xl border-r border-white/10 bg-white/5 shadow-xl shadow-pink-100/10 z-10">
        <Sidebar />
      </aside>

      <main className="flex-1 ml-50 w-full overflow-x-hidden">
